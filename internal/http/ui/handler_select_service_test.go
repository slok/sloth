	...
	tests := map[string]struct {
		...
		"Listing the services should render the full page (With services).": {
			...
			expBody: []string{
				...
				`<a href="/u/app/services?service-search=&service-sort-mode=service-name-asc&component=service-list&backward-cursor=test-prev-cursor" hx-get="/u/app/services?service-search=&service-sort-mode=service-name-asc&component=service-list&backward-cursor=test-prev-cursor" hx-target="#services-list" hx-swap="innerHTML show:window:top"> << Previous </a>`, // We have the pagination prev.
				`<a href="/u/app/services?service-search=&service-sort-mode=service-name-asc&component=service-list&forward-cursor=test-next-cursor" hx-get="/u/app/services?service-search=&service-sort-mode=service-name-asc&component=service-list&forward-cursor=test-next-cursor" hx-target="#services-list" hx-swap="innerHTML show:window:top"> Next >> </a>`,       // We have the pagination next.
			},
		},
		...
		"Listing the services with HTMX on the service list component and forward pagination should render the snippet.": {
			...
			expBody: []string{
				...
				`<a href="/u/app/services?service-search=test&service-sort-mode=service-name-asc&component=service-list&backward-cursor=test-prev-cursor" hx-get="/u/app/services?service-search=test&service-sort-mode=service-name-asc&component=service-list&backward-cursor=test-prev-cursor" hx-target="#services-list" hx-swap="innerHTML show:window:top"> << Previous </a>`, // We have the pagination prev.
				`<a aria-disabled="true" href="" hx-get="" hx-target="#services-list" hx-swap="innerHTML show:window:top"> Next >> </a>`,                                                                                                                                                                                                                                            // We have the pagination next.
			},
		},
		...
		"Listing the services with HTMX on the service list component and backwards pagination should render the snippet.": {
			...
			expBody: []string{
				`<td><a href="/u/app/services/test-svc1">test-svc1</a></td> <td>42</td> <td> <span>32</span> <span class="percent-badge is-critical">76.19%</span> </td> <td> <div class="is-critical"> <i data-lucide="triangle-alert"></i> Firing 1 alerts</div> </td>`,                                                                                              // We have the service.
				`<a aria-disabled="true" href="" hx-get="" hx-target="#services-list" hx-swap="innerHTML show:window:top"> << Previous </a>`,                                                                                                                                                                                                                           // We have the pagination prev.
				`<a href="/u/app/services?service-search=&service-sort-mode=service-name-asc&component=service-list&forward-cursor=test-next-cursor" hx-get="/u/app/services?service-search=&service-sort-mode=service-name-asc&component=service-list&forward-cursor=test-next-cursor" hx-target="#services-list" hx-swap="innerHTML show:window:top"> Next >> </a> `, // We have the pagination next.
			},
		},
		...
		"Searching the services with HTMX should render the snippet.": {
			...
			expBody: []string{
				`<td><a href="/u/app/services/test-svc1">test-svc1</a></td> <td>42</td> <td> <span>32</span> <span class="percent-badge is-critical">76.19%</span> </td> <td> <div class="is-critical"> <i data-lucide="triangle-alert"></i> Firing 1 alerts</div> </td>`,                                                                                                            // We have the service.
				`<a href="/u/app/services?service-search=test&service-sort-mode=service-name-asc&component=service-list&backward-cursor=test-prev-cursor" hx-get="/u/app/services?service-search=test&service-sort-mode=service-name-asc&component=service-list&backward-cursor=test-prev-cursor" hx-target="#services-list" hx-swap="innerHTML show:window:top"> << Previous </a> `, // We have the pagination prev.
				`<a href="/u/app/services?service-search=test&service-sort-mode=service-name-asc&component=service-list&forward-cursor=test-next-cursor" hx-get="/u/app/services?service-search=test&service-sort-mode=service-name-asc&component=service-list&forward-cursor=test-next-cursor" hx-target="#services-list" hx-swap="innerHTML show:window:top"> Next >> </a>`,        // We have the pagination next.
			},
		},
		...
		"Sorting the services by service name with HTMX should render the snippet.": {
			...
			expBody: []string{
				...
				`<td><a href="/u/app/services/test-svc1">test-svc1</a></td> <td>42</td> <td> <span>32</span> <span class="percent-badge is-critical">76.19%</span> </td> <td> <div class="is-critical"> <i data-lucide="triangle-alert"></i> Firing 1 alerts</div> </td>`,                                                                                                             // We have the service.
				`<a href="/u/app/services?service-search=test&service-sort-mode=service-name-desc&component=service-list&backward-cursor=test-prev-cursor" hx-get="/u/app/services?service-search=test&service-sort-mode=service-name-desc&component=service-list&backward-cursor=test-prev-cursor" hx-target="#services-list" hx-swap="innerHTML show:window:top"> << Previous </a>`, // We have the pagination prev.
				`<a href="/u/app/services?service-search=test&service-sort-mode=service-name-desc&component=service-list&forward-cursor=test-next-cursor" hx-get="/u/app/services?service-search=test&service-sort-mode=service-name-desc&component=service-list&forward-cursor=test-next-cursor" hx-target="#services-list" hx-swap="innerHTML show:window:top"> Next >> </a>`,       // We have the pagination next.
			},
		},
		...
		"Sorting the services by status with HTMX should render the snippet.": {
			...
			expBody: []string{
				...
				`<td><a href="/u/app/services/test-svc1">test-svc1</a></td> <td>42</td> <td> <span>32</span> <span class="percent-badge is-critical">76.19%</span> </td> <td> <div class="is-critical"> <i data-lucide="triangle-alert"></i> Firing 1 alerts</div> </td>`,                                                                                       // We have the service.
				`<a href="/u/app/services?service-search=&service-sort-mode=status-asc&component=service-list&backward-cursor=test-prev-cursor" hx-get="/u/app/services?service-search=&service-sort-mode=status-asc&component=service-list&backward-cursor=test-prev-cursor" hx-target="#services-list" hx-swap="innerHTML show:window:top"> << Previous </a>`, // We have the pagination prev.
				`<a href="/u/app/services?service-search=&service-sort-mode=status-asc&component=service-list&forward-cursor=test-next-cursor" hx-get="/u/app/services?service-search=&service-sort-mode=status-asc&component=service-list&forward-cursor=test-next-cursor" hx-target="#services-list" hx-swap="innerHTML show:window:top"> Next >> </a>`,       // We have the pagination next.
			},
		},
