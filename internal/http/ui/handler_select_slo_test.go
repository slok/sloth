	...
	tests := map[string]struct {
		...
		"Listing the slos should render the full page (With slos).": {
			...
			expBody: []string{
				...
				`<th scope="col"> <div hx-get="/u/app/slos?component=slo-list&slo-search=&slo-sort-mode=slo-alert-severity-desc" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Alerts ⇅</th>`,                                    // We have the SLO alerts column with HTMX.
				`<tr> <td class="is-critical"> <span data-tooltip="Individual SLO"><i data-lucide="goal"></i></span> </td> <td> <a href="/u/app/slos/test-svc1-slo1">Test SLO 1</a> </td> <td> </td> <td><a href="/u/app/services/test-svc1">test-svc1</a></td> <td> <span class="percent-badge is-ok">75% </span> </td> <td style="text-align: right;"> <span class="is-ok">20%</span> <span class="percent-bar is-ok"><svg width="100%" height="100%" viewBox="0 0 100 20" xmlns="http://www.w3.org/2000/svg"> <rect x="0" y="1" width="100" height="16" fill="currentcolor" fill-opacity="0.05" stroke="currentcolor" stroke-width="1" rx="1"/> <rect x="0" y="1" width="20.0" height="16" fill="currentcolor" rx="1"/> </svg></span> </td> <td> <div class="is-critical">Critical</div> </td> </tr>`,                                                                                                                         // We have the SLO.
				`<tr> <td class="is-critical"> <span data-tooltip="Individual SLO"><i data-lucide="goal"></i></span> </td> <td> <a href="/u/app/slos/test-svc2-slo2">Test SLO 2</a> </td> <td> </td> <td><a href="/u/app/services/test-svc2">test-svc2</a></td> <td> <span class="percent-badge is-ok">45% </span> </td> <td style="text-align: right;"> <span class="is-ok">50%</span> <span class="percent-bar is-ok"><svg width="100%" height="100%" viewBox="0 0 100 20" xmlns="http://www.w3.org/2000/svg"> <rect x="0" y="1" width="100" height="16" fill="currentcolor" fill-opacity="0.05" stroke="currentcolor" stroke-width="1" rx="1"/> <rect x="0" y="1" width="50.0" height="16" fill="currentcolor" rx="1"/> </svg></span> </td> <td> <div class="is-critical">Critical</div> </td> </tr>`,                                                                                                                         // We have the SLO.
				`<tr> <td> <span data-tooltip="Grouped SLO"><i data-lucide="group"></i></span> </td> <td> <a href="/u/app/slos/test-svc3-slo3:test-grouped">Test SLO 3</a> </td> <td> <div><small><mark>env=<strong>prod</strong></mark></small> <span> </span><small><mark>operation=<strong>create</strong></mark></small> <span> </span></div> </td> <td><a href="/u/app/services/test-svc3">test-svc3</a></td> <td> <span class="percent-badge is-ok">30% </span> </td> <td style="text-align: right;"> <span class="is-ok">65%</span> <span class="percent-bar is-ok"><svg width="100%" height="100%" viewBox="0 0 100 20" xmlns="http://www.w3.org/2000/svg"> <rect x="0" y="1" width="100" height="16" fill="currentcolor" fill-opacity="0.05" stroke="currentcolor" stroke-width="1" rx="1"/> <rect x="0" y="1" width="65.0" height="16" fill="currentcolor" rx="1"/> </svg></span> </td> <td> <div>-</div> </td> </tr>`, // We have the SLO.
				`<a href="/u/app/slos?slo-search=&slo-sort-mode=slo-name-asc&component=slo-list&backward-cursor=test-prev-cursor" hx-get="/u/app/slos?slo-search=&slo-sort-mode=slo-name-asc&component=slo-list&backward-cursor=test-prev-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> << Previous </a>`, // We have the pagination prev.
				`<a href="/u/app/slos?slo-search=&slo-sort-mode=slo-name-asc&component=slo-list&forward-cursor=test-next-cursor" hx-get="/u/app/slos?slo-search=&slo-sort-mode=slo-name-asc&component=slo-list&forward-cursor=test-next-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Next >> </a>`,       // We have the pagination next.
			},
		},
		...
		"Listing the slos filtered by a service should render the full page.": {
			...
			expBody: []string{
				...
				`<tr> <td class="is-critical"> <span data-tooltip="Individual SLO"><i data-lucide="goal"></i></span> </td> <td> <a href="/u/app/slos/test-svc1-slo1">Test SLO 1</a> </td> <td> </td> <td> <span class="percent-badge is-ok">75% </span> </td> <td style="text-align: right;"> <span class="is-ok">20%</span> <span class="percent-bar is-ok"><svg width="100%" height="100%" viewBox="0 0 100 20" xmlns="http://www.w3.org/2000/svg"> <rect x="0" y="1" width="100" height="16" fill="currentcolor" fill-opacity="0.05" stroke="currentcolor" stroke-width="1" rx="1"/> <rect x="0" y="1" width="20.0" height="16" fill="currentcolor" rx="1"/> </svg></span> </td> <td> <div class="is-critical">Critical</div> </td> </tr>`, // SLO row should be ok.
			},
		},
		...
		"Listing the SLOs with HTMX on the SLOs list component and forward pagination should render the snippet.": {
			...
			expBody: []string{
				`<tr> <td class="is-critical"> <span data-tooltip="Individual SLO"><i data-lucide="goal"></i></span> </td> <td> <a href="/u/app/slos/test-svc1-slo1">Test SLO 1</a> </td> <td> </td> <td><a href="/u/app/services/test-svc1">test-svc1</a></td> <td> <span class="percent-badge is-ok">75% </span> </td> <td style="text-align: right;"> <span class="is-ok">20%</span> <span class="percent-bar is-ok"><svg width="100%" height="100%" viewBox="0 0 100 20" xmlns="http://www.w3.org/2000/svg"> <rect x="0" y="1" width="100" height="16" fill="currentcolor" fill-opacity="0.05" stroke="currentcolor" stroke-width="1" rx="1"/> <rect x="0" y="1" width="20.0" height="16" fill="currentcolor" rx="1"/> </svg></span> </td> <td> <div class="is-critical">Critical</div> </td> </tr>`, // SLO row should be ok.
				`<a href="/u/app/slos?slo-search=test&slo-sort-mode=slo-name-asc&component=slo-list&backward-cursor=test-prev-cursor" hx-get="/u/app/slos?slo-search=test&slo-sort-mode=slo-name-asc&component=slo-list&backward-cursor=test-prev-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> << Previous </a>`,                                                                                                                                                                                                                                                                                                                                                                                                                                                                   // We have the pagination prev.
				`<a aria-disabled="true" href="" hx-get="" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Next >> </a>`, // We have the pagination next.
			},
		},
		...
		"Listing the SLOs with HTMX on the SLOs list component and backwards pagination should render the snippet.": {
			...
			expBody: []string{
				`<tr> <td class="is-critical"> <span data-tooltip="Individual SLO"><i data-lucide="goal"></i></span> </td> <td> <a href="/u/app/slos/test-svc1-slo1">Test SLO 1</a> </td> <td> </td> <td><a href="/u/app/services/test-svc1">test-svc1</a></td> <td> <span class="percent-badge is-ok">75% </span> </td> <td style="text-align: right;"> <span class="is-ok">20%</span> <span class="percent-bar is-ok"><svg width="100%" height="100%" viewBox="0 0 100 20" xmlns="http://www.w3.org/2000/svg"> <rect x="0" y="1" width="100" height="16" fill="currentcolor" fill-opacity="0.05" stroke="currentcolor" stroke-width="1" rx="1"/> <rect x="0" y="1" width="20.0" height="16" fill="currentcolor" rx="1"/> </svg></span> </td> <td> <div class="is-critical">Critical</div> </td> </tr>`, // SLO row should be ok.
				`<a aria-disabled="true" href="" hx-get="" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> << Previous </a>`,                                                                                                                                                                                  // We have the pagination prev.
				`<a href="/u/app/slos?slo-search=&slo-sort-mode=slo-name-asc&component=slo-list&forward-cursor=test-next-cursor" hx-get="/u/app/slos?slo-search=&slo-sort-mode=slo-name-asc&component=slo-list&forward-cursor=test-next-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Next >> </a>`, // We have the pagination next.
			},
		},
		...
		"Searching the SLOs with HTMX should render the snippet.": {
			...
			expBody: []string{
				`<tr> <td class="is-critical"> <span data-tooltip="Individual SLO"><i data-lucide="goal"></i></span> </td> <td> <a href="/u/app/slos/test-svc1-slo1">Test SLO 1</a> </td> <td> </td> <td><a href="/u/app/services/test-svc1">test-svc1</a></td> <td> <span class="percent-badge is-ok">75% </span> </td> <td style="text-align: right;"> <span class="is-ok">20%</span> <span class="percent-bar is-ok"><svg width="100%" height="100%" viewBox="0 0 100 20" xmlns="http://www.w3.org/2000/svg"> <rect x="0" y="1" width="100" height="16" fill="currentcolor" fill-opacity="0.05" stroke="currentcolor" stroke-width="1" rx="1"/> <rect x="0" y="1" width="20.0" height="16" fill="currentcolor" rx="1"/> </svg></span> </td> <td> <div class="is-critical">Critical</div> </td> </tr>`, // SLO row should be ok.
				`<a href="/u/app/slos?slo-search=test&slo-sort-mode=slo-name-asc&component=slo-list&backward-cursor=test-prev-cursor" hx-get="/u/app/slos?slo-search=test&slo-sort-mode=slo-name-asc&component=slo-list&backward-cursor=test-prev-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> << Previous </a>`,                                                                                                                                                                                                                                                                                                                                                                                                                                                                   // We have the pagination prev.
				`<a href="/u/app/slos?slo-search=test&slo-sort-mode=slo-name-asc&component=slo-list&forward-cursor=test-next-cursor" hx-get="/u/app/slos?slo-search=test&slo-sort-mode=slo-name-asc&component=slo-list&forward-cursor=test-next-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Next >> </a>`,                                                                                                                                                                                                                                                                                                                                                                                                                                                                         // We have the pagination next.
			},
		},
		...
		"Sorting the SLOs by SLO name with HTMX should render the snippet.": {
			...
			expBody: []string{
				...
				`<th scope="col"> <div hx-get="/u/app/slos?component=slo-list&slo-search=test&slo-sort-mode=slo-alert-severity-desc" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Alerts ⇅</th>`,                                    // We have the SLO alerts column with HTMX.
				`<tr> <td class="is-critical"> <span data-tooltip="Individual SLO"><i data-lucide="goal"></i></span> </td> <td> <a href="/u/app/slos/test-svc1-slo1">Test SLO 1</a> </td> <td> </td> <td><a href="/u/app/services/test-svc1">test-svc1</a></td> <td> <span class="percent-badge is-ok">75% </span> </td> <td style="text-align: right;"> <span class="is-ok">20%</span> <span class="percent-bar is-ok"><svg width="100%" height="100%" viewBox="0 0 100 20" xmlns="http://www.w3.org/2000/svg"> <rect x="0" y="1" width="100" height="16" fill="currentcolor" fill-opacity="0.05" stroke="currentcolor" stroke-width="1" rx="1"/> <rect x="0" y="1" width="20.0" height="16" fill="currentcolor" rx="1"/> </svg></span> </td> <td> <div class="is-critical">Critical</div> </td> </tr>`, // SLO row should be ok.
				`<a href="/u/app/slos?slo-search=test&slo-sort-mode=slo-name-desc&component=slo-list&backward-cursor=test-prev-cursor" hx-get="/u/app/slos?slo-search=test&slo-sort-mode=slo-name-desc&component=slo-list&backward-cursor=test-prev-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> << Previous </a>`,                                                                                                                                                                                                                                                                                                                                                                                                                                                                 // We have the pagination prev.
				`<a href="/u/app/slos?slo-search=test&slo-sort-mode=slo-name-desc&component=slo-list&forward-cursor=test-next-cursor" hx-get="/u/app/slos?slo-search=test&slo-sort-mode=slo-name-desc&component=slo-list&forward-cursor=test-next-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Next >> </a>`,                                                                                                                                                                                                                                                                                                                                                                                                                                                                       // We have the pagination next.
			},
		},
		...
		"Sorting the SLOs by service name with HTMX should render the snippet.": {
			...
			expBody: []string{
				...
				`<th scope="col"> <div hx-get="/u/app/slos?component=slo-list&slo-search=test&slo-sort-mode=slo-alert-severity-desc" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Alerts ⇅</th>`,                                    // We have the SLO alerts column with HTMX.
				`<tr> <td class="is-critical"> <span data-tooltip="Individual SLO"><i data-lucide="goal"></i></span> </td> <td> <a href="/u/app/slos/test-svc1-slo1">Test SLO 1</a> </td> <td> </td> <td><a href="/u/app/services/test-svc1">test-svc1</a></td> <td> <span class="percent-badge is-ok">75% </span> </td> <td style="text-align: right;"> <span class="is-ok">20%</span> <span class="percent-bar is-ok"><svg width="100%" height="100%" viewBox="0 0 100 20" xmlns="http://www.w3.org/2000/svg"> <rect x="0" y="1" width="100" height="16" fill="currentcolor" fill-opacity="0.05" stroke="currentcolor" stroke-width="1" rx="1"/> <rect x="0" y="1" width="20.0" height="16" fill="currentcolor" rx="1"/> </svg></span> </td> <td> <div class="is-critical">Critical</div> </td> </tr>`, // SLO row should be ok.
				`<a href="/u/app/slos?slo-search=test&slo-sort-mode=slo-service-name-desc&component=slo-list&backward-cursor=test-prev-cursor" hx-get="/u/app/slos?slo-search=test&slo-sort-mode=slo-service-name-desc&component=slo-list&backward-cursor=test-prev-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> << Previous </a>`,                                                                                                                                                                                                                                                                                                                                                                                                                                                 // We have the pagination prev.
				`<a href="/u/app/slos?slo-search=test&slo-sort-mode=slo-service-name-desc&component=slo-list&forward-cursor=test-next-cursor" hx-get="/u/app/slos?slo-search=test&slo-sort-mode=slo-service-name-desc&component=slo-list&forward-cursor=test-next-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Next >> </a>`,                                                                                                                                                                                                                                                                                                                                                                                                                                                       // We have the pagination next.
			},
		},
		...
		"Sorting the SLOs by current burning budget with HTMX should render the snippet.": {
			...
			expBody: []string{
				...
				`<th scope="col"> <div hx-get="/u/app/slos?component=slo-list&slo-search=test&slo-sort-mode=slo-budget-remaining-window-period-asc" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Remaining budget (Window) ⇅</th> `, // We have the SLO remaining budget (window) column with HTMX.
				`<th scope="col"> <div hx-get="/u/app/slos?component=slo-list&slo-search=test&slo-sort-mode=slo-alert-severity-desc" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Alerts ⇅</th> </tr>`,                              // We have the SLO alerts column with HTMX.
				`<tr> <td class="is-critical"> <span data-tooltip="Individual SLO"><i data-lucide="goal"></i></span> </td> <td> <a href="/u/app/slos/test-svc1-slo1">Test SLO 1</a> </td> <td> </td> <td><a href="/u/app/services/test-svc1">test-svc1</a></td> <td> <span class="percent-badge is-ok">75% </span> </td> <td style="text-align: right;"> <span class="is-ok">20%</span> <span class="percent-bar is-ok"><svg width="100%" height="100%" viewBox="0 0 100 20" xmlns="http://www.w3.org/2000/svg"> <rect x="0" y="1" width="100" height="16" fill="currentcolor" fill-opacity="0.05" stroke="currentcolor" stroke-width="1" rx="1"/> <rect x="0" y="1" width="20.0" height="16" fill="currentcolor" rx="1"/> </svg></span> </td> <td> <div class="is-critical">Critical</div> </td> </tr>`, // SLO row should be ok.
				`<a href="/u/app/slos?slo-search=test&slo-sort-mode=slo-currently-burning-desc&component=slo-list&backward-cursor=test-prev-cursor" hx-get="/u/app/slos?slo-search=test&slo-sort-mode=slo-currently-burning-desc&component=slo-list&backward-cursor=test-prev-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> << Previous </a>`,                                                                                                                                                                                                                                                                                                                                                                                                                                       // We have the pagination prev.
				`<a href="/u/app/slos?slo-search=test&slo-sort-mode=slo-currently-burning-desc&component=slo-list&forward-cursor=test-next-cursor" hx-get="/u/app/slos?slo-search=test&slo-sort-mode=slo-currently-burning-desc&component=slo-list&forward-cursor=test-next-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Next >> </a>`,                                                                                                                                                                                                                                                                                                                                                                                                                                             // We have the pagination next.
			},
		},
		...
		"Sorting the SLOs by remaining budget with HTMX should render the snippet.": {
			...
			expBody: []string{
				...
				`<th scope="col"> <div hx-get="/u/app/slos?component=slo-list&slo-search=test&slo-sort-mode=slo-alert-severity-desc" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Alerts ⇅</th>`,                                    // We have the SLO alerts column with HTMX.
				`<tr> <td class="is-critical"> <span data-tooltip="Individual SLO"><i data-lucide="goal"></i></span> </td> <td> <a href="/u/app/slos/test-svc1-slo1">Test SLO 1</a> </td> <td> </td> <td><a href="/u/app/services/test-svc1">test-svc1</a></td> <td> <span class="percent-badge is-ok">75% </span> </td> <td style="text-align: right;"> <span class="is-ok">20%</span> <span class="percent-bar is-ok"><svg width="100%" height="100%" viewBox="0 0 100 20" xmlns="http://www.w3.org/2000/svg"> <rect x="0" y="1" width="100" height="16" fill="currentcolor" fill-opacity="0.05" stroke="currentcolor" stroke-width="1" rx="1"/> <rect x="0" y="1" width="20.0" height="16" fill="currentcolor" rx="1"/> </svg></span> </td> <td> <div class="is-critical">Critical</div> </td> </tr>`, // SLO row should be ok.
				`<a href="/u/app/slos?slo-search=test&slo-sort-mode=slo-budget-remaining-window-period-desc&component=slo-list&backward-cursor=test-prev-cursor" hx-get="/u/app/slos?slo-search=test&slo-sort-mode=slo-budget-remaining-window-period-desc&component=slo-list&backward-cursor=test-prev-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> << Previous </a>`,                                                                                                                                                                                                                                                                                                                                                                                                             // We have the pagination prev.
				`<a href="/u/app/slos?slo-search=test&slo-sort-mode=slo-budget-remaining-window-period-desc&component=slo-list&forward-cursor=test-next-cursor" hx-get="/u/app/slos?slo-search=test&slo-sort-mode=slo-budget-remaining-window-period-desc&component=slo-list&forward-cursor=test-next-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Next >> </a>`,                                                                                                                                                                                                                                                                                                                                                                                                                   // We have the pagination next.
			},
		},
		...
		"Sorting the SLOs by alert serverity with HTMX should render the snippet.": {
			...
			expBody: []string{
				...
				`<th scope="col"> <div hx-get="/u/app/slos?component=slo-list&slo-search=test&slo-sort-mode=slo-currently-burning-desc" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Burning budget ⇅</th> `,                        // We have the SLO burning budget column with HTMX.
				`<th scope="col"> <div hx-get="/u/app/slos?component=slo-list&slo-search=test&slo-sort-mode=slo-budget-remaining-window-period-asc" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Remaining budget (Window) ⇅</th> `, // We have the SLO remaining budget (window) column with HTMX.
				`<th scope="col"> <div hx-get="/u/app/slos?component=slo-list&slo-search=test&slo-sort-mode=slo-alert-severity-asc" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Alerts ↓</th>`,                                     // We have the SLO alerts column with HTMX.
				`<tr> <td class="is-critical"> <span data-tooltip="Individual SLO"><i data-lucide="goal"></i></span> </td> <td> <a href="/u/app/slos/test-svc1-slo1">Test SLO 1</a> </td> <td> </td> <td><a href="/u/app/services/test-svc1">test-svc1</a></td> <td> <span class="percent-badge is-ok">75% </span> </td> <td style="text-align: right;"> <span class="is-ok">20%</span> <span class="percent-bar is-ok"><svg width="100%" height="100%" viewBox="0 0 100 20" xmlns="http://www.w3.org/2000/svg"> <rect x="0" y="1" width="100" height="16" fill="currentcolor" fill-opacity="0.05" stroke="currentcolor" stroke-width="1" rx="1"/> <rect x="0" y="1" width="20.0" height="16" fill="currentcolor" rx="1"/> </svg></span> </td> <td> <div class="is-critical">Critical</div> </td> </tr>`, // SLO row should be ok.
				`<a href="/u/app/slos?slo-search=test&slo-sort-mode=slo-alert-severity-desc&component=slo-list&backward-cursor=test-prev-cursor" hx-get="/u/app/slos?slo-search=test&slo-sort-mode=slo-alert-severity-desc&component=slo-list&backward-cursor=test-prev-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> << Previous </a>`,                                                                                                                                                                                                                                                                                                                                                                                                                                             // We have the pagination prev.
				`<a href="/u/app/slos?slo-search=test&slo-sort-mode=slo-alert-severity-desc&component=slo-list&forward-cursor=test-next-cursor" hx-get="/u/app/slos?slo-search=test&slo-sort-mode=slo-alert-severity-desc&component=slo-list&forward-cursor=test-next-cursor" hx-target="#slo-list" hx-swap="innerHTML show:window:top"> Next >> </a>`,                                                                                                                                                                                                                                                                                                                                                                                                                                                   // We have the pagination next.
			},
		},
