...
func init() {
	Symbols["github.com/prometheus/prometheus/promql/parser/parser"] = map[string]reflect.Value{
		...
		"COUNTER_RESET":               reflect.ValueOf(constant.MakeFromLiteral("57436", token.INT, 0)),
		...
		"GAUGE_TYPE":                  reflect.ValueOf(constant.MakeFromLiteral("57438", token.INT, 0)),
		...
		"NOT_COUNTER_RESET":           reflect.ValueOf(constant.MakeFromLiteral("57437", token.INT, 0)),
		...
		"START_EXPRESSION":            reflect.ValueOf(constant.MakeFromLiteral("57443", token.INT, 0)),
		"START_METRIC":                reflect.ValueOf(constant.MakeFromLiteral("57441", token.INT, 0)),
		"START_METRIC_SELECTOR":       reflect.ValueOf(constant.MakeFromLiteral("57444", token.INT, 0)),
		"START_SERIES_DESCRIPTION":    reflect.ValueOf(constant.MakeFromLiteral("57442", token.INT, 0)),
		...
		"STEP":                        reflect.ValueOf(constant.MakeFromLiteral("57432", token.INT, 0)),
		...
		"UNKNOWN_COUNTER_RESET":       reflect.ValueOf(constant.MakeFromLiteral("57435", token.INT, 0)),
