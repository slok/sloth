...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomPrometheusRules) DeepCopyInto(out *CustomPrometheusRules) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
func (in *CustomPrometheusRules) DeepCopy() *CustomPrometheusRules {
	if in == nil {
		return nil
	}
	out := new(CustomPrometheusRules)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PrometheusRuleList) DeepCopyInto(out *PrometheusRuleList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]*CustomPrometheusRules, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CustomPrometheusRules)
