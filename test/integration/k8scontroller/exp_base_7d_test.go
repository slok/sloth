			...
			Groups: []monitoringv1.RuleGroup{
...

				{
					...
					Rules: []monitoringv1.Rule{
						...
						{
							Alert: "myServiceAlert",
							Expr:  intstr.FromString("(\n    max(slo:sli_error:ratio_rate2h{sloth_id=\"svc01-slo01\", sloth_service=\"svc01\", sloth_slo=\"slo01\"} > (1.4000000000000001 * 0.0009999999999999432)) by (owner, sloth_id, sloth_service, sloth_slo, tier)\n    and\n    max(slo:sli_error:ratio_rate1d{sloth_id=\"svc01-slo01\", sloth_service=\"svc01\", sloth_slo=\"slo01\"} > (1.4000000000000001 * 0.0009999999999999432)) by (owner, sloth_id, sloth_service, sloth_slo, tier)\n)\nor\n(\n    max(slo:sli_error:ratio_rate6h{sloth_id=\"svc01-slo01\", sloth_service=\"svc01\", sloth_slo=\"slo01\"} > (0.98 * 0.0009999999999999432)) by (owner, sloth_id, sloth_service, sloth_slo, tier)\n    and\n    max(slo:sli_error:ratio_rate3d{sloth_id=\"svc01-slo01\", sloth_service=\"svc01\", sloth_slo=\"slo01\"} > (0.98 * 0.0009999999999999432)) by (owner, sloth_id, sloth_service, sloth_slo, tier)\n)\n"),
							Labels: map[string]string{
								"alert01k1":      "alert01v1",
